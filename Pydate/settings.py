"""
Django settings for Pydate project.
...
SECRET_KEY = 'j1saxlpew4eidb4r#t5n$br9ka_35ralap#e^267qzko75m4jn'
APPEND_SLASH = True
...
WSGI_APPLICATION = 'Pydate.wsgi.application'
